  ...
  personal: [
    {
      ...
      photos: ["/gallery/bost.jpg", "/gallery/go.jpg"],
    },
    {
      id: 2,
      caption:
        "Weekend gate way to clear my head 🌄 Sometimes inspiration strikes when you’re away from the screen.",
      photos: ["/gallery/vij.jpg", "/gallery/bdg.jpg"],
    },
  ],
  hobbies: [
    {
    ...
    
    {
      ...
      caption:
        "Family",
      photos: ["/gallery/ffm.jpg", "/gallery/fam.jpg"],
    },
  ],
  achievements: [
    {
      id: 1,
      caption: "Also Experienced In Hardware-Software Projects 🏆!",
      photos: ["/gallery/cert.jpg"],
    },
    {
      id: 2,
      caption: "Good Experience In Communication 🤖",
      photos: ["/gallery/ce.jpg"],
    },
  ],
};
  ...
  return (
    ...
    >
      ...
      <motion.div className="tab-buttons" variants={childVariants}>
        {["personal", "hobbies", "achievements"].map((type) => (
          <motion.button
            key={type}
