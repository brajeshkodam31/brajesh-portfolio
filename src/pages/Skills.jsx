...
export default function Skills() {
  ...
  return (
    <section className="skills-container" id="skills">
      ...
      >
        <h2 className="text-5xl text-cyan-400 font-semibold mb-3">Tech Stack (Learning Phase)</h2>
        <div className="w-28 h-[2px] bg-cyan-400 mx-auto mb-6"></div>
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          ✨ “Exploring and learning these technologies step by step, with a strong focus on practical implementation.”
        </p>
      </motion.div>
