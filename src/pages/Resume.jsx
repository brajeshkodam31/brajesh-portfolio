      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margintop: 10, fontSize: 15, color: "#ccc" }}>
              3rd Year Computer Engineering | ARMIET, Mumbai University
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              📍 Bhiwandi, Thane, Maharashtra
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ kodambrajesh11111@gmail.com | 📞 +91 9021932022
            </p>
          </div>
          ...
          >
            ...
            <p style={{ marginTop: 6, color: "#ccc" }}>
              3rd Year computer engineering Student from ARMIET, Mumbai University
              Bhiwandi, Thane, Maharashtra 
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            ...
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — Holy Mary Convent High School</strong> (Maharashtra Board, 2021)
              <br />
